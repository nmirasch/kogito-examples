...
then
    ...
    echo "$KOGITO_VISAS_SVG_FOLDERE does not exist. Have you compiled your Kogito Visas project?"
    #exit 1
fi
...
java -jar  -Dquarkus.http.port=8380 -Dkogito.svg.folder.path=`pwd`/svg management-console-${MANAGEMENT_CONSOLE_VERSION}-runner.jar
